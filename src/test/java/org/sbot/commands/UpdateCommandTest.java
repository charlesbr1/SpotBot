...
import static org.sbot.services.dao.AlertsDao.UpdateField.REPEAT;
...
class UpdateCommandTest {
    ...
    void onCommandRepeat() {
        ...
        var fc2 = spy(CommandContext.of(context, null, messageReceivedEvent, UpdateCommand.NAME +   " repeat 123 -1"));
        assertExceptionContains(IllegalArgumentException.class, "Not a positive value", () -> command.onCommand(fc2));

        var fc3 = spy(CommandContext.of(context, null, messageReceivedEvent, UpdateCommand.NAME +   " repeat 123 1 too"));
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS, () -> command.onCommand(fc3));

        var fc4 = spy(CommandContext.of(context, null, messageReceivedEvent, UpdateCommand.NAME +   " repeat 123 1 23"));
