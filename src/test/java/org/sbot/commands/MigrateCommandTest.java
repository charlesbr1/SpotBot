...
class MigrateCommandTest {
    ...
    void onCommandMigrateById() {
        ...
        var commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " 0"));
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " 0"));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao).getAlertWithoutMessage(TEST_CLIENT_TYPE, alertId);
        verify(alertsDao, never()).update(any(), any());
        ...
        when(alertsDao.getAlertWithoutMessage(TEST_CLIENT_TYPE, alertId)).thenReturn(Optional.of(alert));
        when(messageReceivedEvent.getMember()).thenReturn(null);
        var finalCommandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " 0"));
        ...
        when(alertsDao.getAlertWithoutMessage(TEST_CLIENT_TYPE, alertId)).thenReturn(Optional.of(alert));
        when(messageReceivedEvent.getMember()).thenReturn(null);
        var finalCommandContext2 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " " + serverId));
        ...
        var finalCommandContext3 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " " + serverId));
        ...
        var fc1 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " " + (serverId + 1)));
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " " + (serverId + 1)));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        ...
        when(alertsDao2.getAlertWithoutMessage(TEST_CLIENT_TYPE, alertId)).thenReturn(Optional.of(alert));
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  " + alertId + " " + (serverId + 2)));
        doNothing().when(commandContext).reply(anyList(), anyInt());
    ...
    void onCommandMigrateByFilter() {
        ...
        var fc1 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all 0" ));
        doNothing().when(fc1).reply(anyList(), anyInt());
        assertExceptionContains(IllegalArgumentException.class, "already into the private channel", () -> command.onCommand(fc1));

        var fc2 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all " + serverId));
        ...
        when(discord.guildServer(serverId)).thenReturn(Optional.of(guild));
        var fc3 = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all " + serverId));
        ...
        var commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all " + serverId));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        when(restAction.complete()).thenReturn(mock());
        command.onCommand(commandContext);
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all " + serverId + " <@" + (userId + 1) + "> "));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        verify(alertsDao).updateServerIdOf(any(), eq(serverId));
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/usd  " + serverId + " <@" + (userId) + "> "));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " btc/usd  " + serverId + " trend <@" + (userId) + "> " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/xrp remainder " + serverId));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/usd " + serverId + " <@" + (userId + 2) + "> " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        when(messageReceivedEvent.getMember()).thenReturn(member);
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all " + serverId));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " btc/usd " + serverId + "  remainder " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " btc/usd  range " + serverId));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/usd " + serverId + " <@" + (userId + 3) + "> " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/usd  " + serverId + " trend <@" + (userId + 3) + "> " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
        ...
        commandContext = spy(CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/usd trend " + serverId + " <@" + (userId + 5) + "> " ));
        doNothing().when(commandContext).reply(anyList(), anyInt());
        command.onCommand(commandContext);
        verify(alertsDao, never()).update(any(), any());
    ...
    void arguments() {
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME);
        assertExceptionContains(IllegalArgumentException.class, TICKER_PAIR_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        // id command
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  123 az");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  123 45 az");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  123 45 54");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  123 45");
        ...
        // alert id negative
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  -123");
        assertExceptionContains(IllegalArgumentException.class, "Negative",
                () -> MigrateCommand.arguments(commandContext[0]));

        // filter command
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  a");
        assertExceptionContains(IllegalArgumentException.class, "ticker",
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  azef efefe");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  azefefefel/lklk");
        assertExceptionContains(IllegalArgumentException.class, PAIR_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  bt/l");
        assertExceptionContains(IllegalArgumentException.class, PAIR_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD badType");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  all ");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  all range");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  all range <@123>");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  all 12 <@123> range");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD range ");
        assertExceptionContains(IllegalArgumentException.class, SERVER_ID_ARGUMENT,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD  12 lm");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD range 12 lm");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD 12   <@321> range");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD range 12 <@321> az");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD range 12 <@321> 23");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD range 12 <@321> ar 23");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD  12 <@321> az");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + "  ETH/USD  12 <@321> 23");
        assertExceptionContains(IllegalArgumentException.class, TOO_MANY_ARGUMENTS,
                () -> MigrateCommand.arguments(commandContext[0]));

        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all 12  " );
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all 33 remainder  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all range 66  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all 132 range <@124>  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertEquals(range, arguments.type());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " all trend 52 <@1244>  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " dot/usd  12  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertNull(arguments.type());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " dot/XRP trend 10  " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertEquals(trend, arguments.type());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " ETH/usd 13 remainder " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertEquals(remainder, arguments.type());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " btc/usd 213 remainder <@3210>" );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertEquals(remainder, arguments.type());
        ...
        commandContext[0] = CommandContext.of(context, settings, messageReceivedEvent, MigrateCommand.NAME + " eth/btc  range 120 <@315> " );
        arguments = MigrateCommand.arguments(commandContext[0]);
        assertNotNull(arguments);
        assertNull(arguments.alertId());
        assertEquals(range, arguments.type());
    ...
    void migrateServerAlertsToPrivateChannel() {
        ...
        AlertsDao alertsDao = mock();
        NotificationsDao notificationsDao = mock();
        when(txCtx.userSettingsDao()).thenReturn(settingsDao);
